//
//  TweetImagePresentationController.swift
//  proto_twitter
//
...
class TweetImagePresentationController: UIPresentationController {
    ...
    override func presentationTransitionWillBegin() {
        ...
        overlayView.gestureRecognizers =
            [UITapGestureRecognizer(target: self,
                                    action: #selector(TweetImagePresentationController.overlayViewDidTouch(_:)))
            ]
